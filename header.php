...
<head>
	...
	<?php wp_head(); 
	do_action('include_phbook_styles');
    ?>
</head>
...
<div id="wrapper-container" class="wrapper-container">
	<div class="content-pusher">
		<header id="masthead" class="site-header affix-top<?php thim_header_class(); ?>">
			...
			//Header style
           // var_dump('1',get_theme_mod( 'thim_header_style') );
//            var_dump('2',get_theme_mod( 'thim_header_style', 'header_v1' ) );
//            var_dump('3',get_theme_mod( 'thim_header_style', 'header_v2' ) );
...
//				get_template_part( 'inc/header/' . get_theme_mod( 'thim_header_style', 'header_v2' ) );
//			 }
			?>
		</header>
		<!-- Mobile Menu-->
